...
namespace NuGet.Protocol.Core.Types.Push
{
    public interface IPackageMetadata : IPackageName
    {
        ...
        /// </summary>
        //yugangw IEnumerable<FrameworkAssemblyReference> FrameworkAssemblies { get; }
        
        /// <summary>
        /// Returns sets of References specified in the manifest.
        /// </summary>
        //yugangw ICollection<PackageReferenceSet> PackageAssemblyReferences { get; }

        /// <summary>
        /// Specifies sets other packages that the package depends on.
        /// </summary>
        //yugangw IEnumerable<PackageDependencySet> DependencySets { get; }
