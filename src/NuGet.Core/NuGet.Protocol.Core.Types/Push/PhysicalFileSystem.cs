...
namespace NuGet.Protocol.Core.Types.Push
{
    public class PhysicalFileSystem : IFileSystem
    {
        ...
        private void WriteAddedFileAndDirectory(string path)
        {
            ...
            {
                Logger.LogDebug("NuGetResources.Debug_AddedFileToFolder, Path.GetFileName(path), folderPath");
            }
            else
            {
                Logger.LogDebug("NuGetResources.Debug_AddedFile, Path.GetFileName(path)");
            }
        }
        ...
        public virtual void DeleteFile(string path)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(folderPath))
                {
                    Logger.LogDebug("NuGetResources.Debug_RemovedFileFromFolder, Path.GetFileName(path), folderPath");
                }
                else
                {
                    Logger.LogDebug("NuGetResources.Debug_RemovedFile, Path.GetFileName(path)");
                }
            }
        ...
        public virtual void DeleteDirectory(string path, bool recursive)
        {
            ...
            try
            {
                ...
                Logger.LogDebug("NuGetResources.Debug_RemovedFolder, path");
            }
