...
namespace NuGet.Protocol.Core.Types.Push
{
    public static class PackageRepositoryExtensions
    {
        ...
        internal static IEnumerable<IPackage> FindPackagesByIdCore(IPackageRepository repository, string packageId)
        {
            ...
            {
                //yugangw DNX concern
                packageId = packageId.ToLower(/*yugangw cultureRepository.Culture*/);
            }
            else
            {
                packageId = packageId.ToLower(/*yugangw CultureInfo.CurrentCulture*/);
            }
        ...
        public static IPackage ResolveDependency(this IPackageRepository repository, PackageDependency dependency, IPackageConstraintProvider constraintProvider, bool allowPrereleaseVersions, bool preferListedPackages, 
            /*yugangw DependencyVersion*/object dependencyVersion)
        {
            throw new NotImplementedException();
            //yugangw
        ...
        internal static IPackage SelectDependency(this IEnumerable<IPackage> packages, /*yugangw DependencyVersion*/ object dependencyVersion)
        {
            throw new NotImplementedException();
            //yugangw
